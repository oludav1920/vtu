...
<?php include($_SERVER["DOCUMENT_ROOT"]."/Admin/left.php") ?>
 ...
 <div class="columns2-unequal-middle-div white-bg">      
    <?php
    echo "<hr/>";
        include($_SERVER["DOCUMENT_ROOT"]."/Controller/ElectfetchController.php");
        ...
        if($backendResponseDecode["status"] =="success"){
            ...
            for($i = 0; $i < count($response); $i++){
                ...
                echo '</td>';
                echo '<td>'; 
                echo '<a href="/Admin/electricity/electedit.php?net='.$ind.'">';
                echo '<button>Edit</button>';
                echo '</a>';
                echo '</td>';
                echo '<td>'; 
                echo '<a href="/Controller/ElectdeleteController.php?user='.$ind.'">';
